  ...
  public static void main(String args[]) {
    ...
    try {
     ...
     try {
       ...
       String[] dropTables = {/*"customers", "employees", "menu", "orders", */"inventory", /*"finances"*/}; // edit depending on which 
       ...
       // Create tables (create strings and execute)
        ...
        for (int i = 0; i < employeeList.size(); i++) {
            ...
            // Query String
            String query = String.format("INSERT INTO employees VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s');", 
                                        employeeID, firstName, lastName, payRate, role, startDate, isManager);
        ...
        for (int i = 0; i < inventoryList.size(); i++) {
            ...
            // Query String
            String query = String.format("INSERT INTO inventory VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s');", 
                                        itemID, name, category, expDate, needsFridge, quantity, unit);
        ...
        for (int i = 0; i < financesList.size(); i++) {
            ...
            // Query String
            String query = String.format("INSERT INTO finances VALUES ('%s', '%s', '%s', '%s', '%s');", 
                                        tranID, isDebit, isCredit, details, amount);
        ...
        for (int i = 0; i < ordersList.size(); i++) {
            ...
            // Query string
            String query = String.format("INSERT INTO orders VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');", 
                                        orderID, orderNum, totPrice, date, empID, custID, satisfied, items);
        ...
        for (int i = 0; i < menuList.size(); i++) {
            ...
            // Query string
            String query = String.format("INSERT INTO menu VALUES ('%s', '%s', '%s', '%s', '%s')", 
